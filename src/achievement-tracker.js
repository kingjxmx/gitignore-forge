 ...
 * Shows badge progress for Gitignore Forge and a Day 1 -> Month 1 roadmap.
 * Usage:
...
function printBadgeTable() {
  console.log('=== Gitignore Forge — Achievement Badge Progress ===\n');
...
function printRoadmap() {
  console.log('=== Gitignore Forge — Day 1 -> Month 1 Roadmap ===\n');
  const roadmap = [
